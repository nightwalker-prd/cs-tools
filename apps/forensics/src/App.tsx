...
export default function App() {
  ...
  const [bookmarks, setBookmarks] = usePersistedState<string[]>('forensics-bookmarks', []);
  const [completedChapters, setCompletedChapters] = usePersistedState<number[]>('forensics-completed', []);
  const [quizScores, setQuizScores] = usePersistedState<Record<number, QuizScore>>('forensics-quiz-scores', {});
  ...
  const renderContent = () => {
    ...
    return (
      <div className="max-w-2xl mx-auto text-center py-20 space-y-6">
        ...
        <h2 className="text-2xl font-bold text-[#E6EDF3]">Forensics Explorer</h2>
        <p className="text-[#8B949E] leading-relaxed">
          Digital forensics concepts explorer.
