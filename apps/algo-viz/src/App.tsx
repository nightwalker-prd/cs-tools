...
type AlgorithmType = 'bubble' | 'insertion' | 'selection' | 'merge' | 'quick' | 'binary-search';
...
export default function App() {
  ...
  const currentStep = steps[step] as SortStep | SearchStep | undefined;
  ...
  const pseudocode = algorithm === 'binary-search'
    ? SEARCH_PSEUDOCODE.binary
    : SORTING_PSEUDOCODE[algorithm] || [];

  const isSorting = algorithm !== 'binary-search';
