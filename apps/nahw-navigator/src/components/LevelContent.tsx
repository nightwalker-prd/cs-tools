...
import { getPlaylistName } from '../data/video-mapping';
...
export function LevelContent({ content, showResources, viewMode, activePdfUrl, onSelectPdf }: LevelContentProps) {
  return (
    <div className="level-content animate-fade-in">
      ...
      {content.videos && content.videos.length > 0 && (
        <VideoLessons
          ...
          playlistName={getPlaylistName(content.difficulty)}
        />
      )}
