...
import { PDF_URL, ZOOM_MIN, ZOOM_MAX, ZOOM_STEP, ZOOM_DEFAULT, NAV_IDLE_TIMEOUT, PDF_PAGE_KEY } from '../config/pdf';
...
export function PdfViewer() {
  const [currentPage, setCurrentPage] = usePersistedState<number>(PDF_PAGE_KEY, 1);
