import { Search, Code, CheckCircle2 } from 'lucide-react';
    ...
    <aside className="w-72 bg-[#161B22] border-r border-[#30363D] flex flex-col h-screen">
      <div className="p-4 border-b border-[#30363D]">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h1 className="text-base font-bold text-[#E6EDF3]">LeetCode Guide</h1>
        </div>
        <p className="text-xs text-[#8B949E]">Problem-Solving Patterns</p>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto p-2">
        <div className="px-2 py-1.5 mb-1">
          <span className="text-xs font-medium text-[#8B949E]">
            {completedChapters.length}/{chapters.length} patterns completed
          </span>
