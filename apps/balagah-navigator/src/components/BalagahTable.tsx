import type { BalagahTable as BalagahTableType } from '../data/types';

interface BalagahTableProps {
  table: BalagahTableType;
}
...
export function BalagahTable({ table }: BalagahTableProps) {
  return (
