// Quran structural data - surah names and ayah counts
// Ported from life-os/src/data/quran.ts (subset needed for dhakira)

export const SURAH_DATA: Array<{ number: number; name: string; ayahCount: number }> = [
