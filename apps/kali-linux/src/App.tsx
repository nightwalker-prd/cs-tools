...
export default function App() {
  ...
  const [bookmarks, setBookmarks] = usePersistedState<string[]>('kali-linux-bookmarks', []);
  const [completedChapters, setCompletedChapters] = usePersistedState<number[]>('kali-linux-completed', []);
  const [quizScores, setQuizScores] = usePersistedState<Record<number, QuizScore>>('kali-linux-quiz-scores', {});
  ...
  const renderContent = () => {
    ...
    return (
      <div className="max-w-2xl mx-auto text-center py-20 space-y-6">
        ...
        <h2 className="text-2xl font-bold text-[#E6EDF3]">Kali Linux</h2>
        <p className="text-[#8B949E] leading-relaxed">
          Kali Linux tools & workflow explorer.
