...
import type { Concept } from '../data/topics';
    ...
    <Card className="bg-[#161B22] border-[#30363D] hover:border-[#484F58] transition-colors">
      ...
      >
        <div className="flex items-start gap-2 flex-1 min-w-0">
          {expanded ? (
            <ChevronDown className="w-4 h-4 text-[#CE93D8] shrink-0 mt-0.5" />
          ) : (
      ...
      {expanded && (
        <CardContent className="pt-0 space-y-4">
          <div>
            <h4 className="text-xs font-semibold text-[#CE93D8] uppercase tracking-wider mb-2">Key Points</h4>
