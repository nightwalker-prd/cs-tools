  ...
  if (questions.length === 0) {
    return (
      <div className="max-w-2xl mx-auto text-center py-16">
        <p className="text-[#8B949E]">No quiz questions available for this chapter yet.</p>
      </div>
    );
  }
  ...
  if (isFinished) {
    ...
    return (
      <div className="max-w-2xl mx-auto text-center py-16 space-y-6">
        ...
        <p className="text-sm text-[#8B949E]">Chapter {chapterId}: {chapterTitle}</p>
        <Button
          onClick={() => {
            setCurrentIndex(0);
          ...
          className="bg-[#58A6FF] text-[#0D1117] hover:bg-[#58A6FF]/90"
        >
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      {showExplanation && (
        <div className="bg-[#161B22] border border-[#30363D] rounded-md p-4">
          <h4 className="text-xs font-semibold text-[#58A6FF] uppercase tracking-wider mb-2">Explanation</h4>
      ...
      {selectedAnswer !== null && (
        <div className="flex justify-end">
          <Button onClick={handleNext} className="bg-[#58A6FF] text-[#0D1117] hover:bg-[#58A6FF]/90">
