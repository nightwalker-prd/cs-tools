...
export default function App() {
  ...
  const [bookmarks, setBookmarks] = usePersistedState<string[]>('cloud-security-bookmarks', []);
  const [completedChapters, setCompletedChapters] = usePersistedState<number[]>('cloud-security-completed', []);
  const [quizScores, setQuizScores] = usePersistedState<Record<number, QuizScore>>('cloud-security-quiz-scores', {});
  ...
  const renderContent = () => {
    ...
    return (
      <div className="max-w-2xl mx-auto text-center py-20 space-y-6">
        ...
        <h2 className="text-2xl font-bold text-[#E6EDF3]">Cloud Security Explorer</h2>
        <p className="text-[#8B949E] leading-relaxed">
          Cloud security concepts explorer.
