import { Search, Blocks, CheckCircle2 } from 'lucide-react';
    ...
    <aside className="w-72 bg-[#161B22] border-r border-[#30363D] flex flex-col h-screen">
      <div className="p-4 border-b border-[#30363D]">
        <div className="flex items-center gap-2 mb-1">
          <Blocks className="w-5 h-5 text-[#E3B341]" />
          <h1 className="text-base font-bold text-[#E6EDF3]">Design Patterns</h1>
        </div>
        <p className="text-xs text-[#8B949E]">Software Design Patterns</p>
      </div>
