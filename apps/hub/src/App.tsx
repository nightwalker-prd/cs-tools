...
const tools: Tool[] = [
  ...
  {
    name: 'Cryptography',
    description: 'Deep cryptography — symmetric & asymmetric encryption, hash functions, TLS, digital signatures, post-quantum crypto, and emerging techniques',
    icon: KeyRound,
    color: '#FFD700',
    port: 5208,
    stats: '13 topics, 39 concepts, 39 quiz questions',
  ...
  },
  {
    ...
    description: 'Cyber threat intelligence — CTI lifecycle, MITRE ATT&CK, threat modeling, adversary tracking, STIX/TAXII, threat hunting, and strategic reporting',
    icon: ScanEye,
    color: '#E74C3C',
    port: 5210,
    stats: '13 topics, 39 concepts, 39 quiz questions',
  ...
  {
    name: 'Cloud Security',
    description: 'Cloud security — shared responsibility, IAM, zero trust, container/serverless security, compliance, CSPM, DevSecOps, and cloud incident response',
    icon: CloudCog,
    color: '#3498DB',
    port: 5211,
    stats: '13 topics, 39 concepts, 39 quiz questions',
  ...
  {
    name: 'Self-Hosting',
    description: 'Self-hosting fundamentals — Docker, reverse proxies, media servers, home automation, backups, monitoring, security hardening, and infrastructure as code',
    icon: Home,
    color: '#E67E22',
    port: 5213,
    stats: '13 topics, 39 concepts, 39 quiz questions',
  ...
  {
    name: 'Web Animations',
    description: 'Web animations — CSS transitions, keyframes, transforms, WAAPI, scroll-driven animations, SVG motion, View Transitions API, GSAP, performance, and accessibility',
    icon: Sparkles,
    color: '#E040FB',
    port: 5215,
    stats: '13 topics, 39 concepts, 39 quiz questions',
