...
export default function App() {
  ...
  const [bookmarks, setBookmarks] = usePersistedState<string[]>('threat-intelligence-bookmarks', []);
  const [completedChapters, setCompletedChapters] = usePersistedState<number[]>('threat-intelligence-completed', []);
  const [quizScores, setQuizScores] = usePersistedState<Record<number, QuizScore>>('threat-intelligence-quiz-scores', {});
  ...
  const renderContent = () => {
    ...
    return (
      <div className="max-w-2xl mx-auto text-center py-20 space-y-6">
        ...
        <h2 className="text-2xl font-bold text-[#E6EDF3]">Threat Intelligence</h2>
        <p className="text-[#8B949E] leading-relaxed">
          Cyber threat intelligence concepts explorer.
